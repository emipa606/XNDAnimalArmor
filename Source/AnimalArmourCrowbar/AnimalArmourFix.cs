            ...
            foreach (ThingDef animalDef in animalsInGame)
            {
                switch (animalDef.race.baseBodySize)
                {
                    case float n when n >= 2.4f:
                        animalDef.recipes.Add(DefDatabase<RecipeDef>.GetNamed("InstallMakeshiftAnimalArmorHuge", false));
                    ...
                    case float n when n >= 1.3f:
                        animalDef.recipes.Add(DefDatabase<RecipeDef>.GetNamed("InstallMakeshiftAnimalArmorLarge", false));
                        animalDef.recipes.Add(DefDatabase<RecipeDef>.GetNamed("InstallStandardAnimalArmorLarge", false));
                        animalDef.recipes.Add(DefDatabase<RecipeDef>.GetNamed("InstallHeavyAnimalArmorLarge", false));
                        animalDef.recipes.Add(DefDatabase<RecipeDef>.GetNamed("RemoveMakeshiftAnimalArmorLarge", false));
                    ...
                    case float n when n >= 0.7f:
                        animalDef.recipes.Add(DefDatabase<RecipeDef>.GetNamed("InstallMakeshiftAnimalArmorMedium", false));
                        animalDef.recipes.Add(DefDatabase<RecipeDef>.GetNamed("InstallStandardAnimalArmorMedium", false));
                        animalDef.recipes.Add(DefDatabase<RecipeDef>.GetNamed("InstallHeavyAnimalArmorMedium", false));
                        animalDef.recipes.Add(DefDatabase<RecipeDef>.GetNamed("RemoveMakeshiftAnimalArmorMedium", false));
                        animalDef.recipes.Add(DefDatabase<RecipeDef>.GetNamed("RemoveStandardAnimalArmorMedium", false));
                        animalDef.recipes.Add(DefDatabase<RecipeDef>.GetNamed("RemoveHeavyAnimalArmorMedium", false));
                        break;
                    case float n when n >= 0.3f:
                        animalDef.recipes.Add(DefDatabase<RecipeDef>.GetNamed("InstallMakeshiftAnimalArmorSmall", false));
                        animalDef.recipes.Add(DefDatabase<RecipeDef>.GetNamed("InstallStandardAnimalArmorSmall", false));
                        animalDef.recipes.Add(DefDatabase<RecipeDef>.GetNamed("InstallHeavyAnimalArmorSmall", false));
                        animalDef.recipes.Add(DefDatabase<RecipeDef>.GetNamed("RemoveMakeshiftAnimalArmorSmall", false));
                        ...
                        break;
                    default:
                        animalDef.recipes.Add(DefDatabase<RecipeDef>.GetNamed("InstallMakeshiftAnimalArmorTiny", false));
